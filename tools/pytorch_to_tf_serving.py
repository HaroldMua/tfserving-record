"""
Refer to: https://medium.com/styria-data-science-tech-blog/running-pytorch-models-in-production-fa09bebca622
...
def export_tf_proto(onnx_file, meta_file):
    ...
    tf_rep.export_graph(meta_file)   # export the model
...
def main(args):
    ...
    export_tf_proto(args.onnx_file, args.meta_file)
